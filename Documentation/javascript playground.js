...
// The Advantage of Stripe
// Frontend and Backend separation
// Frontend gets a limited key
const stripe =  Stripe('pk_test');

// Backend get a private key that only our server can use
const stripe = require('stripe')('sk_test');

// Terminal Anatomy
/* C:\Users\John\Desktop>  # Windows
johns-macbook:Desktop$  # Mac
john@ubuntu:~/Desktop$  # Linux

# This shows:
# - Who you are (john)
# - Which computer (macbook)
# - Where you are (Desktop)
...
ls
# Output: 
# Documents  Downloads  Pictures  my-project
...
# touch = Create empty file (Mac/Linux)
touch newfile.txt

# echo = Print text (and create files on Windows)
echo Hello > newfile.txt  # Creates file with "Hello"
